...
/* Q5: Which city has the best customers? We would like to throw a promotional 
...
SELECT ar.artist_id, ar.name,COUNT(ar.name) AS number_of_songs
FROM track t
...
/* Q1: Find how much amount spent by each customer on top artist? Write a query to return customer name,
